...
\caption{\textbf{Intermediate Stiffener Checks}} \label{subsec:intermediate-stiffener} \\
\hline
\textbf{Girder} & \textbf{Check} & \textbf{Required} & \textbf{Provided} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\caption{\textbf{Girder Section Properties (Final Optimized / User-selected)}} \label{subsec:girder-section-props} \\
\hline
...
\caption{\textbf{Girder Section Classification}} \label{subsec:girder-classification} \\
\hline
\textbf{Girder} & \textbf{Element} & \textbf{Slenderness Ratio} & \textbf{Class Limit} & \textbf{Classification} \\[6pt]
\hline
\endfirsthead
...
\vspace{1em}
\begin{longtable}{|C{2.5cm}|C{3.5cm}|C{3.5cm}|>{\centering\arraybackslash}p{4.2cm}|C{1.8cm}|}
\caption{\textbf{Moment Capacity Check}} \label{subsec:moment-capacity} \\
\hline
\textbf{Girder} & \textbf{Parameter} & \textbf{Formula} & \textbf{Value} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\vspace{1em}
\begin{longtable}{|C{2.5cm}|C{3.5cm}|C{3.5cm}|>{\centering\arraybackslash}p{4.2cm}|C{1.8cm}|}
\caption{\textbf{Shear Capacity Check}} \label{subsec:shear-capacity} \\
\hline
\textbf{Girder} & \textbf{Parameter} & \textbf{Formula} & \textbf{Value} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\vspace{1em}
\begin{longtable}{|C{2.5cm}|C{3.5cm}|C{3.5cm}|>{\centering\arraybackslash}p{4.2cm}|C{1.8cm}|}
\caption{\textbf{Interaction Checks (M-V and M-N)}} \label{subsec:interaction-checks} \\
\hline
\textbf{Girder} & \textbf{Check} & \textbf{Condition} & \textbf{Value} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\vspace{1em}
\begin{longtable}{|C{2.5cm}|C{3.5cm}|C{3.5cm}|>{\centering\arraybackslash}p{4.2cm}|C{1.8cm}|}
\caption{\textbf{Lateral Torsional Buckling Check -- Construction Stage}} \label{subsec:ltb-check} \\
\hline
\textbf{Girder} & \textbf{Parameter} & \textbf{Formula} & \textbf{Value} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\caption{\textbf{Stiffener Design Summary}} \label{subsec:stiffener-summary} \\
\hline
...
\caption{\textbf{End Panel Stiffener Checks}} \label{subsec:end-panel-stiffeners} \\
\hline
\textbf{Girder} & \textbf{Check} & \textbf{Required} & \textbf{Provided} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\caption{\textbf{Serviceability -- Deflection Checks}} \label{subsec:sls-deflection} \\
\hline
\textbf{Girder} & \textbf{Check} & \textbf{Allowable} & \textbf{Actual} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\hline
\textbf{Girder} & \textbf{Element} & \textbf{Allowable Stress} & \textbf{Actual Stress} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\caption{\textbf{Serviceability -- Fatigue Assessment}} \label{subsec:sls-fatigue} \\
\hline
\textbf{Girder} & \textbf{Stress Range, $\Delta\sigma$ (MPa)} & \textbf{Fatigue Limit, $f_{fd}$ (MPa)} & \textbf{Utilization Ratio} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\caption{\textbf{Girder Design Summary (DCR / Utilization Ratio)}} \label{subsec:girder-summary-dcr} \\
\hline
...
\caption{\textbf{Shear Connector Capacity}} \label{subsec:shear-connector-capacity} \\
\hline
...
\hline
\multicolumn{4}{|c|}{{\small\itshape \tablename\ \thetable{} -- Continued from previous page}} \\
\hline
\textbf{Parameter} & \textbf{Formula} & \textbf{Value} & \textbf{Reference} \\[6pt]
\hline
\endhead
...
\caption{\textbf{Shear Connector Spacing}} \label{subsec:shear-connector-spacing} \\
\hline
...
\caption{\textbf{Transverse Shear and Detailing Checks}} \label{subsec:transverse-shear-checks} \\
\hline
...
\caption{\textbf{Deck Slab --- Loading and Geometry}} \label{subsec:deck-loading-geom} \\
\hline
...
\caption{\textbf{Deck Slab --- Flexure Check: Interior Panel (Pigeaud's Method)}} \label{subsec:deck-flexure-check} \\
\hline
...
\caption{\textbf{Deck Slab --- Cantilever Overhang Flexure Check}} \label{subsec:deck-cantilever-check} \\
\hline
...
\vspace{1em}
\begin{longtable}{|L{5.5cm}|C{3.5cm}|>{\centering\arraybackslash}p{4.5cm}|C{2cm}|}
\caption{\textbf{Deck Slab --- Punching Shear Check (IRC~112 Cl.~10.4.6)}} \label{subsec:deck-punching-shear} \\
\hline
...
\caption{\textbf{Crack Width Check (Deck Slab)}} \label{subsec:deck-crack-width} \\
\hline
...
\vspace{1em}
\begin{longtable}{|L{5.5cm}|C{3.5cm}|>{\centering\arraybackslash}p{4.5cm}|C{2cm}|}
\caption{\textbf{One-Way (Beam) Shear Check (Deck Slab)}} \label{subsec:deck-oneway-shear} \\
\hline
\textbf{Parameter} & \textbf{Formula / Reference} & \textbf{Value} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
...
\caption{\textbf{Reinforcement Detailing Summary (Deck Slab)}} \label{subsec:deck-rebar-summary} \\
\hline
...
\caption{\textbf{Cross Bracing --- Connection and Section Properties}} \label{subsec:cb-section-props} \\
\hline
...
\caption{\textbf{Cross Bracing --- Slenderness Ratio Check (IS~800 Cl.~3.8 )}} \label{subsec:cb-slenderness-check} \\
\hline
...
\caption{\textbf{Cross Bracing Design --- Capacity Summary}} \label{subsec:cb-capacity-summary} \\
\hline
...
\hline
\multicolumn{8}{|c|}{{\small\itshape \tablename\ \thetable{} -- Continued from previous page}} \\
\hline
\textbf{Panel} & \textbf{Member} & \textbf{Section} & \textbf{Governing LC} & \textbf{Demand (kN)} & \textbf{Capacity (kN)} & \textbf{UR} & \textbf{Status} \\[6pt]
\hline
\endhead
...
\begin{longtable}{|C{2.0cm}|L{2.0cm}|L{2.2cm}|C{2.5cm}|C{2.0cm}|C{2.0cm}|}
\caption{\textbf{End Diaphragm --- Connection and Section Properties}} \label{subsec:ed-section-props} \\
\hline
\textbf{Panel} & \textbf{Member} & \textbf{Connection} & \textbf{Section} & \textbf{$A_g$ (mm²)} & \textbf{$r_{min}$ (mm)} \\[6pt]
\hline
\endfirsthead
...
\vspace{1em}
\begin{longtable}{|C{2.2cm}|L{2.2cm}|L{2.5cm}|C{2.5cm}|C{2.5cm}|>{\centering\arraybackslash}p{3.6cm}|}
\caption{\textbf{End Diaphragm --- Slenderness Ratio Check (IS~800 Cl.~3.8 )}} \label{subsec:ed-slenderness-check} \\
\hline
\textbf{Panel} & \textbf{Member} & \textbf{Nature} & \textbf{Eff.\ Length $KL$ (mm)} & \textbf{$KL/r$} & \textbf{Limit / Status} \\[6pt]
\hline
\endfirsthead
...
\begin{longtable}{|C{2.0cm}|L{1.8cm}|C{2.2cm}|C{3.0cm}|C{1.8cm}|C{1.8cm}|C{1.2cm}|C{1.8cm}|}
\caption{\textbf{End Diaphragm Design --- Capacity Summary}} \label{subsec:ed-capacity-summary} \\
\hline
\textbf{Panel} & \textbf{Member} & \textbf{Section} & \textbf{Governing LC} & \textbf{Demand (kN)} & \textbf{Capacity (kN)} & \textbf{UR} & \textbf{Status} \\[6pt]
\hline
\endfirsthead
